# Week 07 — Portfolio Audit Fix Log
...
Take a screenshot on a real phone before and after the audit and attach it to the Week 07 submission. The code in this folder represents the post-audit version.
